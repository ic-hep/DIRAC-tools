...
# voms-proxy-init --valid 24:00 --voms solidexperiment.org

# lists all files in a directory at 
# srm://maite.iihe.ac.be/pnfs/iihe/solid/solidexperiment.org
...
for dir_name in sys.argv[1:]:
  ...
  fullpath = os.path.join("srm://maite.iihe.ac.be/pnfs/iihe/solid/solidexperiment.org/", dir_name)
